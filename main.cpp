...
#ifdef NAIVE
    if((fout1 = fopen(outfile01, "wb")) == NULL){
        cout << "OUTPUT FILE 01 ERROR." << endl;
        return -1;
    }
    if((fout2 = fopen(outfile02, "wb")) == NULL){
...
#ifdef MMX
    if((fout1 = fopen(outfile11, "wb")) == NULL){
        cout << "OUTPUT FILE 11 ERROR." << endl;
        return -1;
    }
    if((fout2 = fopen(outfile12, "wb")) == NULL){
...
#ifdef SSE
    if((fout1 = fopen(outfile21, "wb")) == NULL){
        cout << "OUTPUT FILE 21 ERROR." << endl;
        return -1;
    }
    if((fout2 = fopen(outfile22, "wb")) == NULL){
...
#ifdef AVX
    if((fout1 = fopen(outfile31, "wb")) == NULL){
        cout << "OUTPUT FILE 31 ERROR." << endl;
        return -1;
    }
    if((fout2 = fopen(outfile32, "wb")) == NULL){
